  ...
  return (
    <>
        ...
        <header>
            <div className='container flex_space'>
                {/* <div className='logo'>
                    <img src='./img/logo.png' alt='' width=""></img>
                </div> */}
            </div>

            {/* <div className='contact flex_space'>
                <div className='box felx_space'>
                    <div className='icons'>
                        <i className='far fa-clock'></i>
                    </div>
                    <div className='text'>
                        <h4>Working Hours</h4>
                        <Link to="/contact">Monday - Sunday : 8.00 am to 6.00 pm</Link>
                    </div>
                </div>
                <div className='box felx_space'>
                    <div className='icons'>
                    ...
                    <div className='text'>
                        <h4>Call Us</h4>
                        <Link to="/contact">+021 123 123</Link>
                    </div>
                </div>
                <div className='box felx_space'>
                    <div className='icons'>
                    ...
                    <div className='text'>
                        <h4>Mail Us</h4>
                        <Link to="/contact">info@hotelbook.com</Link>
                    </div>
                </div>
            </div> */}
        </header>
